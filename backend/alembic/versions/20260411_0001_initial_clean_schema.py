...
def upgrade() -> None:
    ...
    if not inspector.has_table("teaching_sessions"):
        op.create_table(
            ...
            sa.Column("weak_points", postgresql.JSONB(), nullable=False, server_default=sa.text("'[]'")),
            sa.Column("messages", postgresql.JSONB(), nullable=False, server_default=sa.text("'[]'")),
    ...
    if not inspector.has_table("exams"):
        op.create_table(
            ...
            sa.Column("questions", postgresql.JSONB(), nullable=False, server_default=sa.text("'[]'")),
            sa.Column("user_answers", postgresql.JSONB(), nullable=False, server_default=sa.text("'[]'")),
            sa.Column("persona_answers", postgresql.JSONB(), nullable=False, server_default=sa.text("'[]'")),
